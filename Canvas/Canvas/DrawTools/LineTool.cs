...
{
  internal class NodePointLine : INodePoint
  {
    public enum ePoint
    {
      P1,
    ...
    private Line m_owner;
    private Line m_clone;
  ...
  internal class Line : DrawObjectBase, IDrawObject, ISerialize
  {
    ...
    public bool ObjectInShape(ICanvas canvas, List<PointF> shape, bool anyPoint)
    {
      ...
      if (anyPoint)
        return HitUtil.LineIntersectWithPolygon(m_p1, m_p2, shape);
  ...
  internal class LineEdit : Line, IObjectEditInstance
  {
