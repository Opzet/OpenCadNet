...
namespace Canvas.DrawTools
{
  ...
  internal class NodePointArcCenter : INodePoint
  {
  ...
  internal class NodePointArcRadius : INodePoint
  {
    protected Arc m_owner;
    protected Arc m_clone;
  ...
  internal class NodePointArcAngle : INodePoint
  {
    protected Arc m_owner;
    protected Arc m_clone;
  ...
  internal class Arc : DrawObjectBase, IArc, IDrawObject, ISerialize
  {
