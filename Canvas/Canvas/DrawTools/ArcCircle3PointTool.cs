...
{
  internal class NodePointArc3PointPoint : INodePoint
  {
  ...
  internal class Arc3Point : DrawObjectBase, IArc, IDrawObject, ISerialize
  {
    ...
    private eArcType m_type = eArcType.kArc3P132;
    ...
    private eDirection m_direction = eDirection.kCCW;
    ...
    private void Draw3P123(ICanvas canvas, RectangleF unitrect)
    {
    ...
    private eDrawObjectMouseDown MouseDown3P132(ICanvas canvas, UnitPoint point, ISnapPoint snappoint)
    {
    ...
    private eDrawObjectMouseDown MouseDown3P123(ICanvas canvas, UnitPoint point, ISnapPoint snappoint)
    {
      OnMouseMove(canvas, point);
      if (m_curPoint == eCurrentPoint.p1)
      {
    ...
    public virtual bool ObjectInShape(ICanvas canvas, List<PointF> shape, bool anyPoint)
    {
